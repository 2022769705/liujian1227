package cn.itdashu.aigou.web.controller;

import cn.itdashu.aigou.AjaxResult;
import cn.itdashu.aigou.domain.Employee;
...
public class LoginController {
    ...
    //本身服务地址访问  http://localhost:8001/lget
    //通过网关访问：端口 + 前缀 + 映射 路径 + 方法路径 http://localhost:9001/aigou/login/lget
